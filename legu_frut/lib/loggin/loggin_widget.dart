...
class LogginWidget extends StatefulWidget {
  ...
  static String routeName = 'Loggin';
  static String routePath = '/loggin';
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 12.0, 0.0, 24.0),
                                                child: Text(
                                                  'Empecemos llenando información de ti ',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                      .override(
                                                      ...
                                                      child: Wrap(
                                                        ...
                                                        children: [
                                                          Padding(
                                                           ...
                                                           // BOTON CONTINUAR CON APPLE - REGISTRO
                                                           Padding(
                                                             ...
                                                             child: FFButtonWidget(
                                                               ...
                                                               icon: FaIcon(FontAwesomeIcons.apple, size: 20.0),
                                                               options: FFButtonOptions(
                                                                 width: 230.0,
                                                                 height: 44.0,
