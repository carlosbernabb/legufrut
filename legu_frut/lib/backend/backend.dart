...
import 'schema/ordersitems_record.dart';
...
export 'schema/ordersitems_record.dart';
...
/// Functions to query OrdersitemsRecords (as a Stream and as a Future).
Future<int> queryOrdersitemsRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      OrdersitemsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<OrdersitemsRecord>> queryOrdersitemsRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      OrdersitemsRecord.collection(parent),
      OrdersitemsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<OrdersitemsRecord>> queryOrdersitemsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
